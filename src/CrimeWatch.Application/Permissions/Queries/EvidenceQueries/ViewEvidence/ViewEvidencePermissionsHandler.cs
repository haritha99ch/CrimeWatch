...
internal class ViewEvidencePermissionsHandler : RequestPermissions, IRequestHandler<ViewEvidencePermissions, EvidencePermissions>
{
    ...
    private async Task<EvidencePermissions> GetPermissionToViewEvidenceById(EvidenceId evidenceId, CancellationToken cancellationToken)
    {
