...
internal static class EvidenceConfiguration
{
    internal static void Configure(this OwnedNavigationBuilder<Report, Evidence> builder)
    {
        ...
        builder.OwnsOne<Location>(e => e.Location, navigationBuilder => navigationBuilder.Configure());
        ...
        builder.Property(e => e.AuthorId).HasConversion(id => id != null ? id.Value : default, value => new(value));

        builder.HasOne(e => e.Moderator).WithMany().HasForeignKey(e => e.ModeratorId);
        builder.Property(e => e.ModeratorId).HasConversion(id => id != null ? id.Value : default, value => new(value));
    }
}
