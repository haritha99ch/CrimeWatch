...
import {
  CreateAccountForModerator,
  CreateAccountForWitness,
...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isModerator) {
      ...
      if (!createdModerator) return; // TODO: Something went wrong
    ...
    if (!createdWitness) return; // TODO: Something went wrong
    navigate("/Account/SignIn");
  };
    ...
    <>
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
          <form
            id="formSection"
            className="border border-black/5 p-5 dark:dark-mode-bg-secondary rounded-2xl"
            ...
            <div id="form-gender" className="form-group flex">
              ...
              <div id="form-gender-content" className="flex gap-x-5">
                <div>
                  <label
                    htmlFor="gender-male"
                    className="dark:dark-mode-text-secondary">
                    Male{" "}
                  </label>
                  <input
                    required
            ...
            <div id="form-switchType">
              ...
              <label
                ...
                Create an Account for Moderator
              </label>
            </div>
            {isModerator && (
              <>
            ...
            <div id="form-submit" className="form-group flex gap-x-5">
              ...
              <button type="reset" className="px-3 py-3 text-red-600">
                Reset
              </button>
            </div>
          </form>
